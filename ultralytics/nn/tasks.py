    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in {
            ...
            if m in {BottleneckCSP, C1, C2, C2f, C2fAttn, C3, C3TR, C3Ghost, C3x, RepC3,
                     C2fCIB, C2f_Faster, C2f_ScConv, CSP_PTB, C2f_HDRAB, C2f_RAB, CSP_MutilScaleEdgeInformationSelect, C2f_ODConv}:
        ...
        elif m in {Detect, Detect_AFPN,WorldDetect, Segment, Pose, OBB, ImagePoolingAttn, v10Detect}:
